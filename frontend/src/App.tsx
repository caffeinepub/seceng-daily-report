    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <header className="sticky top-0 z-50 bg-surface border-b border-border shadow-lg">
        <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-base font-black uppercase tracking-widest text-foreground leading-none font-display">
              SECURITY ENGINEERING INC.
            </h1>
            <p className="text-sm text-muted-foreground tracking-wider uppercase mt-0.5">Daily Field Report</p>
          </div>
        </div>
      </header>
      ...
      <div className="bg-surface border-b border-border">
        <div className="max-w-3xl mx-auto px-4 py-5">
          <p className="text-sm text-muted-foreground uppercase tracking-widest mb-4">Field Documentation System</p>
